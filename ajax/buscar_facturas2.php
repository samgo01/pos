<?php
	...
	if (isset($_GET['id'])){
		...
		$del1="delete from compras where numero_factura='".$numero_factura."'";
		$del2="delete from detalle_compras where numero_factura='".$numero_factura."'";
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = "";
		 $sWhere.=" WHERE compras.id_cliente=proveedores.id_cliente and compras.id_vendedor=users.user_id";
		if ( $_GET['q'] != "" )
		{
		$sWhere.= " and  (proveedores.nombre_cliente like '%$q%' or compras.numero_factura like '%$q%')";
			
		}
		
		$sWhere.=" order by compras.id_factura desc";
