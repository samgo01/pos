			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td class='text-center'><?php echo $existencia; ?></td>
						<td class='col-xs-1'>
						<div class="pull-right">
						<input type="number" class="form-control" style="text-align:right" id="cantidad_<?php echo $id_producto; ?>"  required min="1" pattern="^[0-9]+" value="1" >
						</div></td>
